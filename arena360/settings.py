"""
Django settings for arena360 project.
...
SECRET_KEY = 'django-insecure-+uoy@hryx7wsha(o5^pn-=vg_k7dk3komast@$v*cej@9b4&sw'
...
# TEMPLATES[0]['DIRS'] = [
#     BASE_DIR / 'arena360' / 'frontend' / 'templates'
# ]



WSGI_APPLICATION = 'arena360.wsgi.application'
